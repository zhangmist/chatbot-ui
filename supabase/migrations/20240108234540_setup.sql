...
AS $$
DECLARE
  project_url TEXT := 'https://bkszhodilceavkmeknwu.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJrc3pob2RpbGNlYXZrbWVrbnd1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjkzMzYzNiwiZXhwIjoyMDIyNTA5NjM2fQ.B6WkyUcnFbYzOnBVfllw5KSliLPsfsDN8wanfwSEaW8'; -- full access needed for http request to storage
